...
Public Class alpha
    ...
    Private Sub alpha_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrintPreview()
        del()
    End Sub
    ...
    Function GetOrderList()
        ...
        Try
            ...
            cmd.CommandText = "SELECT * FROM tbl_alphalist"
    ...
    Public Sub PrintPreview()
        ...
        Try
            ...
            rptDocument.Load(Application.StartupPath & "\alphalist.rpt")
    ...
    Public Sub del()
        Try
            ...
            Dim SqlQuery As String = "DELETE FROM tbl_alphalist"
            With SqlCommand
