...
Public Class Form4
    ...
    Function GetOrderList()
        ...
        Try
            ...
            cmd.CommandText = "SELECT * FROM tbl_payroll_rpt"
    ...
    Public Sub PrintPreview()
        ...
        Try
            ...
            rptDocument.Load(Application.StartupPath & "\payroll_report.rpt")
    ...
    Public Sub del()
        Try
            ...
            Dim SqlQuery As String = "DELETE FROM tbl_payroll_rpt"
            With SqlCommand
