...
Public Class full_report2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.full_report2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfull_report2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As full_report2 = New full_report2()
        rpt.Site = Me.Site
        Return rpt
    End Function
