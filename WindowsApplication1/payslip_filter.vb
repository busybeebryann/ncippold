...
Public Class payslip_filter
    Dim conn As New SqlConnection("Data Source=BUSYBEE-CHAD-PC\SQLEXPRESS2;Initial Catalog=payroll_db;User ID=sa;Password=mainpass")
    ...
    Public Sub dtgv()
        ...
        Try
            SQL = "SELECT * FROM tbl_payroll WHERE [department] LIKE '%" + ComboBox2.Text.Trim + "%' AND position LIKE '%" + ComboBox1.Text.Trim + "%' AND emp_name LIKE '%" + TextBox1.Text + "%'"
            Label6.Text = SQL
            conn.Open()
