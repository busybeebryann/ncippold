...
Public Class att_printer
    Dim dsOrder As New DataSet
    Dim strsql As String
    Private Sub att_printer_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        PrintPreview()
        del()
    End Sub
    ...
    Function GetOrderList()
        ...
        Try
            ...
            cmd.CommandText = "SELECT * FROM tbl_att"
    ...
    Public Sub PrintPreview()
        ...
        Try
            ...
            rptDocument.Load(Application.StartupPath & "\attReport.rpt")
    ...
    Public Sub del()
        Try
            ...
            Dim SqlQuery As String = "DELETE FROM tbl_att"
            With SqlCommand
